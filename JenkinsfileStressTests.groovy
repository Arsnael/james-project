                        ...
                        script {
                            ...
                            switch (params.PROFILE) {
                                ...
                                case "s3":
                                    ...
                                    sh 'docker run -d --env "S3BACKEND=file" --env "REMOTE_MANAGEMENT_DISABLE=1" --env "SCALITY_ACCESS_KEY_ID=accessKey1" --env "SCALITY_SECRET_ACCESS_KEY=secretKey1" --name=s3 zenko/cloudserver:8.2.6'
