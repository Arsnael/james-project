...
public class CassandraRecipientRewriteTableV7Test extends AbstractCassandraRecipientRewriteTableTest {
    ...
    protected AbstractRecipientRewriteTable getRecipientRewriteTable() throws Exception {
        ...
        when(mockCassandraSchemaVersionDAO.getCurrentSchemaVersion()).thenReturn(CompletableFuture.completedFuture(Optional.of(SCHEMA_VERSION_V7)));
